...
//Method Three - Mark the test as Transactional.  This will make
//Spring *roll back* the transaction after each test.  Note that this
//is the opposite behaviour of using @Transactional non test code.
@Transactional
public class TrackControllerTest {
    ...
    public void testGetWithQuery() throws Exception {
        ...
        actions = actions.andExpect(jsonPath("$[0].artist", Matchers.containsString("Jim Hall and Ron Carter")));
        MvcResult result = actions.andReturn();
        System.out.println("result is " + result);
    }
